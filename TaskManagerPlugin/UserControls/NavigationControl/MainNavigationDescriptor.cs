...
namespace TaskManagerPlugin.UserControls.NavigationControl
{
    ...
    public class MainNavigationDescriptor : ToolWindowDescriptor
    {
        public MainNavigationDescriptor(IApplicationHost host, IWindowBranding branding) : base(host, branding)
        {
        }

        public MainNavigationDescriptor(IApplicationHost host) : base(host)
        {
        }
    }
}